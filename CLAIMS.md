...
|---|---|---|---|---|
| `draughtsman-c9` | `measure-type` | `README.md`, `tools/measure_type.py` | 2026-09-03 | A tool that reports the size a figure's type will actually render at, for print or a page |
