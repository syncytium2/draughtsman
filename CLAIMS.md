...
|---|---|---|---|---|
| `draughtsman-65` | `spec-review` | `SPEC.md`, `examples/tube/README.md`, `tests/test_claims.py` | 2026-09-03 | Murderboard findings on SPEC.md, and restoring the creation carve-out I broke in test_claims |
