...
|---|---|---|---|---|
| `draughtsman-4f` | `draw-the-net` | `examples/gallery/cocktail.py`, `tests/test_cocktail.py` | 2026-09-05 | Actually try to trace and draw the cocktail-party net, which was the original question |
