...
|---|---|---|---|---|
| `draughtsman-a4` | `torchview-2x` | `index.html`, `examples/gallery/README.md`, `examples/gallery/whisper/torchview.png` | 2026-09-05 | Committing the torchview raster at 2x so it stays sharp at the size it is shown |
