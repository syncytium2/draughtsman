...
|---|---|---|---|---|
| `draughtsman-a4` | `whisper-attribution` | `examples/gallery/whisper_tiny.py`, `THIRD_PARTY_NOTICES.md`, `README.md`, `index.html` | 2026-09-07 | Whisper-tiny follows OpenAI's MIT implementation and nothing here says so |
