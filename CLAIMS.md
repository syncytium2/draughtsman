...
|---|---|---|---|---|
| `draughtsman-c9` | `site-in-repo` | `README.md` | 2026-09-03 | The site and the glyph writeup exist only as private artifacts; nothing in the repo records them or can reach them |
