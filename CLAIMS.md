...
|---|---|---|---|---|
| `draughtsman-c9` | `path-to-public` | `README.md`, `pyproject.toml`, `CONTRIBUTING.md`, `tests/test_readme_links.py` | 2026-09-03 | The remaining path-to-public items: CONTRIBUTING, two stories into the README, PyPI prep with a link check, and pruning the merged branches |
