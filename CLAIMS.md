...
|---|---|---|---|---|
| `draughtsman-c4` | `no-home-paths` | `lit/README.md`, `tests/test_no_personal_paths.py` | 2026-09-05 | A public repo spells an absolute home directory in a code block, and nothing here has ever checked for one |
