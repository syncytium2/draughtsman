...
| paper | for | held |
|---|---|---|
| von der Malsburg & Schneider 1986, *A neural cocktail-party processor*, Biological Cybernetics 54:29–40 | a candidate gallery model: a dynamical net whose output is a synchrony pattern rather than a tensor | see `_NEEDED.md` |
